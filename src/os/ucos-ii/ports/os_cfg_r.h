...
#define OS_TASK_IDLE_STK_SIZE   64//128u   /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TMR_CFG_TICKS_PER_SEC 500u   /*     Rate at which timer management task runs (Hz)            */
