...
/**
 * @brief          This function is used to register volumedb control callback 
                   which would be called while to get or set volumedb
                   control
 *
...
/**
 * @brief          This function is used to register loudness control callback 
                   which would be called while to get or set loudness
                   control
 *
