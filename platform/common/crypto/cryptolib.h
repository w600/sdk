...
/*
	Helpers
*/
extern s32 psBase64decode(const unsigned char *in,  u32 len,
                    unsigned char *out, u32 *outlen);
...
extern CK_RV pkcs11OpenSession(CK_SESSION_HANDLE *session, s32 flags);
