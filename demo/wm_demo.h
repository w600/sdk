...
//socket demo
#define DEMO_STD_SOCKET_CLIENT	    (DEMO_OFF)	//标准接口socket client
#define DEMO_STD_SOCKET_SERVER	    (DEMO_OFF)	//标准接口socket server

#define DEMO_UDP                    (DEMO_OFF)   //udp 单播和广播

//联网demo，可以用一键配置联网，也可以主动用接口联网
#define DEMO_CONNECT_NET			DEMO_ON

//apsta联网demo，可以用一键配置联网，也可以主动用接口联网
#define DEMO_APSTA   		  		(DEMO_OFF)

//串口收发测试
#define DEMO_UARTx   		  		(DEMO_OFF)

//AP dmeo
#define DEMO_SOFT_AP   		  		(DEMO_OFF)
...
//rsa demo
#define DEMO_RSA				    DEMO_OFF

//rtc demo
#define DEMO_RTC				    DEMO_OFF

//timer demo
#define DEMO_TIMER				    DEMO_OFF

//pwm demo
#define DEMO_PWM					DEMO_OFF

//pmu demo
#define DEMO_PMU					DEMO_OFF

//ntp demo
#define DEMO_NTP					(DEMO_ON)
